...
object APIUtil {
    ...
    fun uploadStream(uri: Uri, url: String, lat: String, lng: String, time:String, mime: MediaType, context: Context) {
        ...
        val data = """{"mode":"$mode","lat":"$lat","lng":"$lng","time:":"$time","data":"$cleanBase64"}""".toRequestBody(MIME_JSON)
    ...
    fun uploadData(state:String, url: String, lat: String, lng: String, time:String, mime: MediaType) {
        ...
        val data = """{"mode":"$mode","lat":"$lat","lng":"$lng","time:":"$time","data":"$state"}""".toRequestBody(MIME_JSON)
        val request = Request.Builder()
            .url(url)
            .post(data)
            .build()
    ...
    fun uploadSimulation(state:String, url: String, lat: String, lng: String) {
        val data = """{"lat":"$lat","lng":"$lng","data":"$state"}""".toRequestBody(MIME_JSON)
        val request = Request.Builder()
            .url(url)
            .post(data)
            .build()
    ...
    val BASE_URL = "http://164.8.200.22:3000/net/"
